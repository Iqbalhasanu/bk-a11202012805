...
?>
<div class="container mt-5" style="background-color: #e0f7fa; padding: 20px;">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center" style="font-weight: bold; font-size: 32px; color: white; background-color: #00bfa5;">Register</div>
                <div class="card-body">
                    <form method="POST" action="index.php?page=pendaftaranPasien">
                        ...
                        <div class="text-center mt-3">
                            <button type="submit" class="btn btn-primary btn-block" style="background-color: #00bfa5;">Register</button>
                        </div>
                    </form>
                </div>
            </div>
